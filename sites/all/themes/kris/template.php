 ...
 */
function kris_html_head_alter(&$head_elements) {
 ...
 */
function kris_preprocess_page(&$vars) {
 ...
 */
function kris_process_page(&$vars) {
  $page = &$vars['page'];
 ...
 */
function kris_preprocess_region(&$vars) {
 ...
 */
function kris_preprocess_block(&$vars) {
  $block = &$vars['block'];
 ...
 */
function kris_menu_tree__menu_footer_sitemap($vars) {
 ...
 */
function kris_menu_link__menu_footer_sitemap($vars) {
 ...
 */
function kris_system_powered_by() {
  return '© ' . date('Y') . ' <a href="' . base_path() . '">' . variable_get('site_name') . '</a>. ' .
    ...
    ' ' . t('and') . ' <a href="http://drupal.tonystar.me/kris">kris</a>.';
}

/**
 * Preprocesses variables for poll-bar.tpl.php.
 */
function kris_preprocess_poll_bar(&$vars) {
 ...
 */
function kris_preprocess_item_list(&$vars) {
 ...
 */
function kris_preprocess_links(&$vars) {
  $vars['attributes']['class'][] = 'list-unstyled';
}
